...
const sortOptions = [
  { value: 'sales', labelKey: 'common.sort.mostSold' },
...
export default function BestSellingPageClient({
  initialProducts,
  initialTotal,
  initialPages,
  initialCategories,
      ...
      <div className="container mx-auto px-4 py-4 md:py-8 mt-16 md:mt-20 mb-20 md:mb-0">
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h1 className="text-3xl font-bold">{t('products.bestSelling.bestSellingProducts')}</h1>
          </div>
          <p className="text-muted-foreground">
            {t('products.bestSelling.discoverOurMostPopularFashionItems')}
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <Input
                placeholder={t('products.bestSelling.searchBestSellingProducts')}
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-full lg:w-48 h-12">
                <SelectValue placeholder={t('products.bestSelling.sortBy')} />
              </SelectTrigger>
              <SelectContent>
            ...
            >
              ...
              {t('products.bestSelling.filters')}
              <ChevronDown
                size={16}
              ...
              <Sheet>
                ...
                <SheetContent side="left" className="w-80 p-0 bg-card">
                  <SheetHeader className="p-6 pb-0 text-left">
                    <SheetTitle className="text-left text-xl font-semibold text-foreground">{t('products.bestSelling.filters')}</SheetTitle>
                  </SheetHeader>
                  <div className="p-6">
                    <MobileFilterContent
        ...
        <div className="hidden lg:flex gap-8">
          ...
          <div className="flex-1">
            <div className="mb-4 flex items-center justify-between">
              <p className="text-muted-foreground">
                {t('common.showingOfItems', { shown: products.length, total: pagination.total, items: t('products.bestSelling.bestSellingProducts2') })}
              </p>
              {hasActiveFilters && (
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">{t('products.bestSelling.activeFilters')}</span>
                  {searchQuery && (
                  ...
                  {minRating > 0 && (
                    <Badge variant="secondary" className="gap-1">
                      {minRating}{t('products.bestSelling.stars')}
                      <X
                        size={12}
                        className="cursor-pointer"
                              ...
                              <div className="flex-1 p-6 flex flex-col justify-between">
                                <div>
                                  <p className="text-sm text-subtle-foreground font-medium uppercase tracking-wide mb-2">
                                    {product.category?.name || t('products.bestSelling.bestSeller')}
                                  </p>
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <div className="flex gap-2">
                                    ...
                                    >
                                      ...
                                      {t('products.bestSelling.addToCart')}
                                    </Button>
                                  </div>
                                </div>
                              </div>
            ...
            {!loading && products.length === 0 && (
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2">{t('products.bestSelling.noBestSellingProductsFound')}</h3>
                <p className="text-muted-foreground mb-4">
                  {t('products.bestSelling.tryAdjustingYourSearchCriteriaOr')}
                </p>
                <Button onClick={clearFilters}>{t('products.bestSelling.clearAllFilters')}</Button>
              </motion.div>
            )}
        ...
        <div className="lg:hidden bg-card">
          ...
          {hasActiveFilters && (
            <div className="mb-4">
              <div className="flex flex-wrap gap-2">
                <span className="text-sm text-muted-foreground">{t('products.bestSelling.filters2')}</span>
                {searchQuery && (
                  <Badge variant="secondary" className="gap-1">
                    "{searchQuery}"
                    <X
          ...
          {!loading && products.length === 0 && (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">{t('products.bestSelling.noBestSellingProductsFound')}</h3>
              <p className="text-muted-foreground text-sm mb-4">
                {t('products.bestSelling.tryAdjustingYourSearchOrFilters')}
              </p>
              <Button onClick={clearFilters} size="sm">{t('products.bestSelling.clearAllFilters')}</Button>
            </motion.div>
          )}
...
const MobileFilterContent = ({
  ...
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <h3 className="font-semibold">{t('products.bestSelling.filters')}</h3>
      <Button variant="ghost" size="sm" onClick={clearFilters}>
        {t('products.bestSelling.clearAll')}
      </Button>
    </div>

    {/* Category Filter */}
    <div className="space-y-3">
      <h4 className="font-medium">{t('products.bestSelling.category')}</h4>
    ...
    {/* Price Range */}
    <div className="space-y-3">
      <h4 className="font-medium">{t('products.bestSelling.priceRange')}</h4>
      <Slider
        value={priceRange}
    ...
    {/* Color Filter */}
    <div className="space-y-3">
      <h4 className="font-medium">{t('products.bestSelling.color')}</h4>
    ...
    {/* Rating Filter */}
    <div className="space-y-3">
      <h4 className="font-medium">{t('products.bestSelling.minimumRating')}</h4>
        ...
        {[4, 3, 2, 1].map(rating => (
          <div key={rating} className="flex items-center space-x-2">
            ...
            <label htmlFor={`mobile-rating-${rating}`} className="flex items-center space-x-1 text-sm cursor-pointer">
              ...
              <span>{t('products.bestSelling.up')}</span>
            </label>
          </div>
        ))}
      </div>
